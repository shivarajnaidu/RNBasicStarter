...
const CircleSvg = ({ x, y, radius, angle, color, circleRadius }) => {
  var end = polarToCartesian(x, y, radius, angle * 0.9999);
  return <Circle cx={end.x} cy={end.y} r={circleRadius} fill={color} />;
};
